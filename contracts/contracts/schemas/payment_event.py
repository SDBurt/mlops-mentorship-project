"""
Unified payment event schema and event type mappings.

This module defines the canonical payment event format that all provider-specific
events are normalized to. It serves as the contract between:
- Normalizer (produces)
- Orchestrator (consumes)
- Dagster/Iceberg (persists)
