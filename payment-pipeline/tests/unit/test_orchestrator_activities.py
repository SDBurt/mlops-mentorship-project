...
class TestValidateBusinessRules:
    ...
    def test_valid_event_passes(self, valid_event: dict) -> None:
        ...
        from orchestrator.activities.validation import (
            MAX_AMOUNT_CENTS,
            ALLOWED_CURRENCIES,
    ...
    def test_amount_bounds_validation(self) -> None:
        ...
        from orchestrator.activities.validation import MAX_AMOUNT_CENTS
    ...
    def test_currency_validation(self) -> None:
        ...
        from orchestrator.activities.validation import ALLOWED_CURRENCIES
